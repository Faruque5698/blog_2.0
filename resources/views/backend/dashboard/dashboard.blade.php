                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="steamline m-t-40">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="{{asset('backend')}}/assets/images/users/1.jpg"> </div>
                                    <div class="sl-right">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="{{asset('backend')}}/assets/images/users/2.jpg"> </div>
                                    <div class="sl-right">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img class="img-circle" alt="user" src="{{asset('backend')}}/assets/images/users/3.jpg"> </div>
                                    <div class="sl-right">
